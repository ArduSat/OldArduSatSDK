...
void loop(void) {
  ...
  storage.store_exp_data((uint8_t*)&ir, sizeof(uint16_t));
  storage.store_exp_data((uint8_t*)&full, sizeof(uint16_t));
  storage.store_exp_data((uint8_t*)&lum, sizeof(uint32_t));
